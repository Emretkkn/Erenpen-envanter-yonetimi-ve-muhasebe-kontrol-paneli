      ...
      <div class="sidebar-scroll">
        <nav>
          <ul class="nav">
            ...
            <li><a href="tedarikciler.php" class="active"><i class="fa fa-phone"></i><span>Tedarikçiler</span></a></li>
        ...
        <div class="col">
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h2 class="panel-title"><b>Tedarikçi Ekle</h2>
						</div>
             ...
             <div class="container-fluid">
              <div class="row">
                 ...
                 <form action="" method="post">
                  <table class="table">
                          ...
                          <tr>
                          <td></td>
                          <td><input class="btn btn-primary"  type="submit" value="Tedarikçi Ekle"></td>
                          </tr>
              ...
              //yeni
                  ...
                  // Veri alanlarının boş olmadığını kontrol ettiriyoruz. Başka kontrollerde yapabilirsiniz.
                      ...
                      if ($conn->query("INSERT INTO tedarikciler (tedarik_ad) VALUES ('$ad')"))
                      {
                          echo "Tedarikçi Eklendi"; // Eğer veri eklendiyse eklendi yazmasını sağlıyoruz.
                      }
                      else
                      {
                          echo "Hata oluştu";
          ...
          <div class="panel panel-scrolling">
						<div class="panel-heading">
							<h2 class="panel-title"><b>Tedarikçiler</h2>
						</div>
						<div class="panel-body">
              <div class="col">
                ...
                $sorgu = $conn->query("SELECT * FROM tedarikciler"); // Model tablosundaki tüm verileri çekiyoruz.

                while ($sonuc = $sorgu->fetch_assoc()) {

                $tedarikid = $sonuc['tedarik_id']; // Veritabanından çektiğimiz id satırını $id olarak tanımlıyoruz.
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><a href="tedariksil.php?tedarik_id=<?php echo $tedarikid; ?>" class="btn btn-danger">Sil</a></td>
                    </tr>
