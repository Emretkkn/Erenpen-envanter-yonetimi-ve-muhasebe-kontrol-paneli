      ...
      <div class="sidebar-scroll">
        <nav>
          <ul class="nav">
            ...
            <li><a href="firmalar.php" class="active"><i class="lnr lnr-apartment"></i><span>Firmalar</span></a></li>
        ...
        <div class="col">
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h2 class="panel-title"><b>Firma Ekle</h2>
						</div>
             ...
             <div class="container-fluid">
              <div class="row">
                 ...
                 <form action="" method="post">
                  <table class="table">
                          ...
                          <tr>
                          <td></td>
                          <td><input class="btn btn-primary"  type="submit" value="Firma Ekle"></td>
                          </tr>
              ...
              //yeni
                  ...
                  // Veri alanlarının boş olmadığını kontrol ettiriyoruz. Başka kontrollerde yapabilirsiniz.
                      ...
                      if ($conn->query("INSERT INTO firmalar (firma_ad) VALUES ('$ad')"))
                      {
                          echo "Firma Eklendi"; // Eğer veri eklendiyse eklendi yazmasını sağlıyoruz.
                      }
                      else
                      {
                          echo "Hata oluştu";
          ...
          <div class="panel panel-scrolling">
						<div class="panel-heading">
							<h2 class="panel-title"><b>Firmalar</h2>
						</div>
						<div class="panel-body">
              <div class="col">
                ...
                $sorgu = $conn->query("SELECT * FROM firmalar"); // Model tablosundaki tüm verileri çekiyoruz.

                while ($sonuc = $sorgu->fetch_assoc()) {

                $firmaid = $sonuc['firma_id']; // Veritabanından çektiğimiz id satırını $id olarak tanımlıyoruz.
                $firmaad = $sonuc['firma_ad'];
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><a href="firmasil.php?firma_id=<?php echo $firmaid; ?>" class="btn btn-danger">Sil</a></td>
                    </tr>
